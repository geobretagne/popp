                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    ...
                                    <?= drupal_render($nodeToDisplay['field_popp_photo_date']) ?>
                                    <?= drupal_render($nodeToDisplay['field_popp_photo_author']) ?>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <?= drupal_render($nodeToDisplay['field_popp_photo_editor']) ?>
                                    <?= drupal_render($nodeToDisplay['field_popp_photo_contributor']) ?>
                                    <?= drupal_render($nodeToDisplay['field_popp_photo_copyright']) ?>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
